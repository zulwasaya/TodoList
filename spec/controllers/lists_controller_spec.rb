  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved list as @list" do
        ...
        post :create, {:list => { "description" => "invalid value" }}, valid_session
        assigns(:list).should be_a_new(List)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested list" do
        ...
        List.any_instance.should_receive(:update_attributes).with({ "description" => "MyText" })
        put :update, {:id => list.to_param, :list => { "description" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the list as @list" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        List.any_instance.stub(:save).and_return(false)
        put :update, {:id => list.to_param, :list => { "description" => "invalid value" }}, valid_session
        assigns(:list).should eq(list)
      end
