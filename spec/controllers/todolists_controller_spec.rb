  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved todolist as @todolist" do
        ...
        post :create, {:todolist => { "task" => "invalid value" }}, valid_session
        assigns(:todolist).should be_a_new(Todolist)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested todolist" do
        ...
        Todolist.any_instance.should_receive(:update_attributes).with({ "task" => "MyString" })
        put :update, {:id => todolist.to_param, :todolist => { "task" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the todolist as @todolist" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Todolist.any_instance.stub(:save).and_return(false)
        put :update, {:id => todolist.to_param, :todolist => { "task" => "invalid value" }}, valid_session
        assigns(:todolist).should eq(todolist)
      end
